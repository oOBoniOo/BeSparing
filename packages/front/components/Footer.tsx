  ...
  <footer className="text-center text-white bg-gray-900">
      ...
      <div className="grid lg:grid-cols-4 md:grid-cols-2">
        <div className="mb-6">
          ...
          <ul className="mb-0 list-none">
            ...
            <li>
              <Link href="#!">
                <div className="text-gray-300 ">Link 3</div>
              </Link>
            </li>
            <li>
              <Link href="#!">
                <div className="text-gray-300 ">Link 4</div>
              </Link>
            </li>
          </ul>
        </div>
    ...
    <div className="p-4 text-center">
      <style jsx>
        {`
          div {
            background-color: rgb(243, 152, 153);
          }
        `}
      </style>
      © 2022 Copyright:
      <a className="text-white" href="https://github.com/oOBoniOo" target="_blank" rel="noreferrer">
        oOBoniOo
      </a>
    </div>
  </footer>
